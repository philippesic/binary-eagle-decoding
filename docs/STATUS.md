...
goal. The next research milestone proposed by the overview is model preparation
and drafter graph audit, followed by W1A1 acceptance work. Measure target-only
and FP16 EAGLE in direct comparison with native W1A1, including SM75-specific
measurements on RTX 2080 Ti. The user decides the next official goal.
